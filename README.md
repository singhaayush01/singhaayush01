...
<details>
  <summary><b>🧠 Gutenberg Text Transformer</b> — <a href="https://github.com/singhaayush01/TinyTextGPT-Gutenberg-Text-Transformer">repo</a></summary>
  <br/>
  From-scratch mini Transformer in PyTorch. Data from Project Gutenberg, custom BPE tokenizer, clean training loop, and experiments to understand attention, positional encoding, and scaling laws behavior on small corpora.
</details>

<details>
  <summary><b>🌐 Cliffe College Web Work</b> — <a href="https://github.com/singhaayush01">portfolio</a></summary>
  <br/>
  Built and maintained responsive pages in React/Drupal; improved performance, accessibility (WCAG), and consistency across YSU departments; collaborated with design and content teams to ship production changes.
</details>

<details>
  <summary><b>🤖 AI Experiments Collection</b> — <a href="https://github.com/singhaayush01?tab=repositories">repos</a></summary>
  <br/>
  A grab-bag of NLP, RL, and GenAI experiments: tokenizers, training/eval utilities, data pipelines, and deployment prototypes.
</details>
